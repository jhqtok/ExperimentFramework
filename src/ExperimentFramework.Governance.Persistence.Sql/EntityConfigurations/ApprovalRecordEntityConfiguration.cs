...
/// <summary>
/// Entity configuration for ApprovalRecordEntity.
/// </summary>
public class ApprovalRecordEntityConfiguration : IEntityTypeConfiguration<ApprovalRecordEntity>
{
    public void Configure(EntityTypeBuilder<ApprovalRecordEntity> builder)
    {
        ...
        // Properties
        builder.Property(e => e.ApprovalId)
            .IsRequired()
            .HasMaxLength(100);
        ...
        builder.Property(e => e.GateName)
            .IsRequired()
            .HasMaxLength(200);

        builder.Property(e => e.Approver)
            .HasMaxLength(200);
